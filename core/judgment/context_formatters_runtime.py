"""Judgment context formatters focused on runtime and memory sections."""
...
if TYPE_CHECKING:
    ...
    from core.perception import EthosState, JudgmentSignals, Percept, PerceptionReplaySummary
