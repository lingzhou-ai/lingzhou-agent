"""core.loop.tick_parts.execution_finalize - 执行阶段与 tick 收尾。"""
...
from ..chat import _bind_chat_id
from ..common import (
    _HINT_TIERS,
    _JUDGMENT_TIERS,
...
from ..focus import adopt_result_task, finalize_focus_task, resolve_focus_task
from ..logging import (
    _clip_signal_text,
...
from .memory_post import _post_tick_memory
from .shared import _build_tool_context, _log, _loop_metabolic
...
async def _maybe_run_tick_evolution(loop: Any, cycle: int, perception_replay: Any) -> None:
    ...
    for evolve_result in results:
        if evolve_result.success:
            from .prep_judgment import console
